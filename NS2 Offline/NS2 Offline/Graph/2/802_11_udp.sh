...
output_file1="$output_file_format$under$thrvsderat.out"
output_file2="$output_file_format$under$thrvsdrrat.out"
output_file3="$output_file_format$under$thrvstm.out"
output_file4="$output_file_format$under$thrvser.out"
...
do
	...
	if [ "$l" == "1" ]; then
		...
		echo -ne "$val " >> $output_file1
		echo -ne "$val " >> $output_file2
		echo -ne "$val " >> $output_file3
		echo -ne "$val " >> $output_file4
	elif [ "$l" == "2" ]; then
