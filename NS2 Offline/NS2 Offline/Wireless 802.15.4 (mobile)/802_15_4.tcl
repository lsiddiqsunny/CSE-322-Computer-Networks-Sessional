...
if {$num_node >= 50} {
	set num_col [expr 2*$num_col]; #if number of node greater than 50,doubling column number
}
set num_row [expr $num_node/$num_col]
puts "row : $num_row  col: $num_col"
set tcp_src Agent/UDP; #using udp 
set tcp_sink Agent/Null ; #so sink is null
